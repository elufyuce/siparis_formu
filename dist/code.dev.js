...
//Girdi değişkenleri
var urunTipi, urunSecimi, urunSayisi, urunTaksidi; //Çıktı değişkenleri

var araToplam,
    odenecekToplamTutar,
    kargoUcreti = 19.90; //Global döngü değişkeni

var i; //Global nesne değişkenleri

var liste, secenek; //Dizi tipindeki değişkenler

var erkekParfumleri = ["Celvin Clein", 100, "Lacoste", 120, "Axe", 30, "First Class", 50, "Giorgio Armani", 1000, "Versace", 600];
var kadinParfumleri = ["Burbery", 150, "Avon", 80, "She", 60, "Nina Ricci", 130, "Chanel", 500, "Giorgio Armani", 800];
